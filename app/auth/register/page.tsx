          ...
          <form onSubmit={handleMasterPasswordSetup}>
            <CardContent className="space-y-4">
              ...
              {error && (
                ...
                {/* Important Warning - Softer Approach */}
                <Alert className="border-amber-200 bg-amber-50 dark:bg-amber-950/20 dark:border-amber-800">
                  <AlertTriangle className="h-4 w-4 text-amber-600 dark:text-amber-400" />
                <AlertDescription>
                    <strong className="text-amber-800 dark:text-amber-200">⚠️ Important Warning:</strong> If you forget your master password, you will permanently lose access to ALL your data. 
              ...
              <div className="space-y-2">
                ...
                <div className="mt-6 p-4 border-2 border-amber-200 dark:border-amber-800 rounded-lg bg-amber-50/50 dark:bg-amber-950/10">
                  <div className="flex items-start space-x-3">
                    <input
                      ...
                      required
                    />
                    <label htmlFor="acknowledge-warning" className="text-sm text-amber-800 dark:text-amber-200 font-medium">
